...
class hybrid_mesh_meshless_sph_surface_vertex_t;
class hybrid_mesh_meshless_sph_body_t;

} // namespace mechanics
namespace xpbd {

class hybrid_mesh_meshless_sph_collision_constraint_t : public constraint_t
{
  public:
  ...
  private:
    ...
    mechanics::hybrid_mesh_meshless_sph_body_t const* b_;            ///< The meshless body
    mechanics::hybrid_mesh_meshless_sph_surface_vertex_t const& vk_; ///< Penetrating vertex
