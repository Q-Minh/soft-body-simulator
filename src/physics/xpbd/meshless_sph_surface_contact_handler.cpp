...
meshless_sph_surface_contact_handler_t::meshless_sph_surface_contact_handler_t(
    simulation_t& simulation)
    : simulation_(simulation)
{
}

void meshless_sph_surface_contact_handler_t::on_cd_starting() {}

void meshless_sph_surface_contact_handler_t::on_cd_ending() {}

void meshless_sph_surface_contact_handler_t::handle(collision::contact_t const& contact)
{
    ...
    if (contact_type == collision::contact_t::type_t::surface_particle_to_sdf)
    {
        ...
        mechanics::meshless_sph_surface_t const* surface_mesh =
            dynamic_cast<mechanics::meshless_sph_surface_t const*>(&visual_model);
        if (!surface_mesh)
        {
            return;
        }
        ...
        auto collision_constraint = std::make_unique<xpbd::meshless_sph_collision_constraint_t>(
