...
meshless_sph_stvk_constraint_t::meshless_sph_stvk_constraint_t(
...
Eigen::Matrix3d meshless_sph_stvk_constraint_t::green_strain(Eigen::Matrix3d const& Fi) const
{
...
std::pair<scalar_type, Eigen::Matrix3d> meshless_sph_stvk_constraint_t::strain_energy_and_stress(
...
scalar_type const meshless_sph_stvk_constraint_t::C(scalar_type const Psi) const
{
    return node_.Vi() * Psi;
}

std::vector<Eigen::Vector3d>
meshless_sph_stvk_constraint_t::dCdxk(Eigen::Matrix3d const& dPsidFi) const
{
    std::vector<index_type> const& neighbours = node_.neighbours();
