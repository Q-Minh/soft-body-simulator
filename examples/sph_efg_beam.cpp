...
#include <sbs/physics/mechanics/sph_efg_model.h>
...
int main(int argc, char** argv)
{
    ...
    using meshless_model_type  = sbs::physics::mechanics::sph_efg_model_t<kernel_function_type>;
    ...
    for (sbs::index_type k = 0u; k < mechanical_model.integration_point_count(); ++k)
    {
        ...
        sbs::index_type const ti   = mechanical_model.tetrahedron_of_integration_point(k);
        ...
        auto constraint =
            std::make_unique<sbs::physics::xpbd::sph_integration_constraint_t<meshless_model_type>>(
                alpha,
                beta,
                k,
                beam_idx,
